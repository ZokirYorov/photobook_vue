    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
      <div class="overflow-x-auto">
        ...
        <div v-else class="text-center py-16">
          <p class="text-gray-500 text-lg font-semibold">Vinetka topilmadi !</p>
        </div>
      </div>
    </div>
        ...
        <form @submit.prevent="saveForm" class="p-6 space-y-4">
          <div>
            ...
            <input
                ...
                placeholder="Bitiruvchilar Vinetka"
            >
          </div>
...
const vinCategories = computed(() => dataStore.state.vignetteCategory);
